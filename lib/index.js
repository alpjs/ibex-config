...
exports.default = ibexConfig;

var _storedConfig = require('./storedConfig');

var _storedConfig2 = _interopRequireDefault(_storedConfig);
...
function getConfig(path) {
    if (_storedConfig2.default.has(path)) {
        return _storedConfig2.default.get(path);
    }
...
function existsConfig(path) {
    if (_storedConfig2.default.has(path)) {
        return _storedConfig2.default.get(path) !== false;
    }
    return fetchConfig(path);
}
        ...
        return regeneratorRuntime.wrap( /**
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        if (!(_storedConfig2.default.getVersion() === version && _storedConfig2.default.has('_appConfig'))) {
                            _context.next = 2;
                            break;
                        }

                        return _context.abrupt('return', _storedConfig2.default.get('_appConfig'));

                    case 2:

                        _storedConfig2.default.clear(version);
                    ...
                    case 5:
                        ...
                        _storedConfig2.default.set('_appConfig', config);
 ...
 * @function
 * @param configPath
*/function ibexConfig(configPath) {
                ...
                return regeneratorRuntime.wrap( /**
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 5:
                                config = getOrFetchAppConfig(version, app.environment, configPath);
